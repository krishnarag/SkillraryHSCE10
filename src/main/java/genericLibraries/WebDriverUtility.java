...
/**
 * this method waits util elements/ elements is found
 * @param time
 */
     ...
     * @return 
      ...
      */
    	...
    	/**
    	 * this method is used to wait until web page title is dispalyed
    	 * @param time
    	 * @param title
    	 * @return
    	 */
    	...
    	/**
    	 * this method is used to mouse to an element
    	 * @param element
    	 */
    	 ...
    	 * 
    	 */
    	public void dragAndDropElement(WebElement element, WebElement traget) {
    		Actions actions = new Actions(driver);
    		actions.dragAndDrop(element, traget).perform();
    	}
    	/**
    	 ...
    	 * @param index
    	 */
    	public void swithchToFrame(int index) {
    	driver.switchTo().frame(index);
    	}
    	
    	/**
    	 * this method is used to switch to frame using id or attribute value
    	 * @param idOrName
    	 */
